...
<div class="announcement">
    <div class="announcementMain clearfix">
        <div class="announcementMainL">
            <img src="~/assets/images/common/newsNav.png" class="announcementNavImg">
            <div class="announcementMainLBox" v-for="(item,index) in listArr" @click="goNewsDetails(item.id)">
...
export default {
  ...
  methods:{   
    listData() {
        let _this = this
        axios({
            url: '/information/selectInformationListPC',
            method: 'post',
            params: {
                pageSize: this.pageSize, //每页数据量s
